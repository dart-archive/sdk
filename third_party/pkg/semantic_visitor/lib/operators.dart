...
class UnaryOperator {
  ...
  const UnaryOperator(this.kind, this.name, {this.isUserDefinable: true});

  String toString() => name;

  /// The unary ! operator.
  static const UnaryOperator NOT =
      const UnaryOperator(UnaryOperatorKind.NOT, '!', isUserDefinable: false);

  /// The unary - operator.
  static const UnaryOperator NEGATE =
      const UnaryOperator(UnaryOperatorKind.NEGATE, '-');
...
class BinaryOperator {
  ...
  const BinaryOperator._(this.kind, this.name, {this.isUserDefinable: true});
  ...
  /// The != operator.
  static const BinaryOperator NOT_EQ = const BinaryOperator._(
          BinaryOperatorKind.NOT_EQ, '!=', isUserDefinable: false);
