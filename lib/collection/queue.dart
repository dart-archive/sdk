 ...
 */
// TODO(ager): Should we use EfficientLength?
...
abstract class Queue<E> implements Iterable<E> {
   ...
   * Creates a queue.
   */
  // TODO(ager): Doesn't work with Fletch:
...
//      }
  ...
  E get first {
    if (_head == _tail) throw _IterableErrors.noElement();
    return _table[_head];
  }
  ...
  E get single {
    if (_head == _tail) throw _IterableErrors.noElement();
    if (length > 1) throw _IterableErrors.tooManyElements();
    return _table[_head];
  }
