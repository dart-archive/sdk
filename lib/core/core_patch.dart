...
// This patch is derived from the Dart VM's runtime/lib/date_patch.dart.
@patch class DateTime {
  ...
  @dartino.native external static int _getCurrentMicros();
...
@patch class Uri {
  ...
  @dartino.native static String _base() {
