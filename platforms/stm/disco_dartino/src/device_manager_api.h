...
#ifndef PLATFORMS_STM_DISCO_DARTINO_SRC_DEVICE_MANAGER_API_H_
#define PLATFORMS_STM_DISCO_DARTINO_SRC_DEVICE_MANAGER_API_H_
...
#endif  // PLATFORMS_STM_DISCO_DARTINO_SRC_DEVICE_MANAGER_API_H_
