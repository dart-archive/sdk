...
#ifndef PLATFORMS_STM_DISCO_DARTINO_SRC_FREERTOSIPCONFIG_H_
#define PLATFORMS_STM_DISCO_DARTINO_SRC_FREERTOSIPCONFIG_H_
...
#endif  // PLATFORMS_STM_DISCO_DARTINO_SRC_FREERTOSIPCONFIG_H_
