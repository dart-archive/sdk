...
void MyApiService::destroy(int32_t api) {
  ...
  char _bits[kSize];
  char* _buffer = _bits;
  *reinterpret_cast<int32_t*>(_buffer + 32) = api;
...
void MyApiService::MyObject_funk(int32_t api, int32_t id, int32_t o) {
  ...
  char* _buffer = _bits;
  *reinterpret_cast<int32_t*>(_buffer + 32) = api;
  *reinterpret_cast<int32_t*>(_buffer + 36) = id;
  *reinterpret_cast<int32_t*>(_buffer + 40) = o;
...
static void Unwrap_void_16(void* raw) {
  typedef void (*cbt)();
  char* buffer = reinterpret_cast<char*>(raw);
  cbt callback = *reinterpret_cast<cbt*>(buffer + 48);
  free(buffer);
  callback();
}
...
void MyApiService::MyObject_funkAsync(int32_t api, int32_t id, int32_t o, void (*callback)()) {
  ...
  *reinterpret_cast<int32_t*>(_buffer + 36) = id;
  *reinterpret_cast<int32_t*>(_buffer + 40) = o;
  *reinterpret_cast<void**>(_buffer + 48) = reinterpret_cast<void*>(callback);
