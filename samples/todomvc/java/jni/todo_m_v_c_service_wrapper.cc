...
static const MethodId _kclearItemsId = reinterpret_cast<MethodId>(2);
...
static const MethodId _kdispatchId = reinterpret_cast<MethodId>(3);
...
JNIEXPORT void JNICALL Java_fletch_TodoMVCService_dispatch(JNIEnv* _env, jclass, jchar id) {
  ...
  char* _buffer = _bits;
  *reinterpret_cast<int64_t*>(_buffer + 48) = 0;
  *reinterpret_cast<jchar*>(_buffer + 56) = id;
...
static const MethodId _ksyncId = reinterpret_cast<MethodId>(4);
...
static const MethodId _kresetId = reinterpret_cast<MethodId>(5);
