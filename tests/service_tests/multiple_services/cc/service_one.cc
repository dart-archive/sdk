...
#include "service_one.h"
#include "include/service_api.h"
#include <stdlib.h>

static ServiceId service_id_ = kNoServiceId;

void ServiceOne::setup() {
  service_id_ = ServiceApiLookup("ServiceOne");
}

void ServiceOne::tearDown() {
...
int32_t ServiceOne::echo(int32_t arg) {
...
void ServiceOne::echoAsync(int32_t arg, void (*callback)(int32_t, void*), void* callback_data) {
